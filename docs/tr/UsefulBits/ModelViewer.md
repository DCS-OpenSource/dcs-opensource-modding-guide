...
Özel EDM'lerinizden texture yüklemek için ek yapılandırma gerekir.

`"C:\Users\{YOUR_USERNAME}\Saved Games\edModelViewerTrunk\"` yoluna gidin ve `autoexec.lua` dosyasını açın. Dosya yoksa oluşturun.

Aşağıdaki Lua kodunu `autoexec.lua` dosyasına kopyalayıp yapıştırın.

Ardından 13. satırı Saved Games/DCS kurulumunuzu gösterecek şekilde düzenleyin. Örnekler:
...
Geri kalan her şeyi olduğu gibi bırakın; hazır.
